...
const BLOG = {
  ...
  AVATAR: '/myself.png', // 个人头像 默认取public目录下的avatar.png
  KEYWORDS: 'web, Notion, 博客，技术', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/LoveMyself546',
  CONTACT_TELEGRAM: '',
  ...
  WIDGET_PET_LINK:
    'https://proxy.wannacry.cf/https/cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json',
